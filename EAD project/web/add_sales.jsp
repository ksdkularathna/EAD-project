<%-- 
    Document   : add_sales
    Created on : Nov 26, 2015, 9:48:42 PM
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="active">Sales</a>
                                    <ul class="sub">
                                        <li class="active"><a  href="add_sales.jsp">Add Sales</a></li>
                ...
                <section class="wrapper">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal tasi-form" method="post" action="addSale">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Customer Name</label>
                                    <div class="col-sm-10">
                                        <input name="cus_name" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Engine ID</label>
                                    <div class="col-sm-10">
                                        <input name="eng_id" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Engine Category</label>
                                    <div class="col-sm-2">
                                        <select name="eng_category" class="form-control input-medium m-bot15" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="eng_model" type="text" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="cc" type="text" class="form-control" required>                                      
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Mounting Type</label>
                                    <div class="col-sm-2">
                                        <select name="m_type" class="form-control input-medium m-bot15" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="cus_contact" type="text" class="form-control" required>                                      
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-danger">Add Sale</button>
                                    </div>
                                </div>
