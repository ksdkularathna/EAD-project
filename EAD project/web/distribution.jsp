<%-- 
    ...
    Created on : Nov 26, 2015, 9:54:15 PM
...
<%@page import="mappings.Distribution"%>
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a  href="distribution.jsp">Distribution</a></li>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample3">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            List<Distribution> list = sess.createQuery("from Distribution order by iddistribution desc").list();
                                            for (Distribution distr : list) {
                                        %>
                                        <tr class="">
                                            <td><%=distr.getSales().getIdsales()%></td>
                                            <td><%=distr.getSales().getCusName()%></td>
                                            <td><%=distr.getDestination()%></td>
                                            <td class="center"><%=distr.getCharge()%></td>
